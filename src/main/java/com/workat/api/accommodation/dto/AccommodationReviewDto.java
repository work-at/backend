...
public class AccommodationReviewDto {
	...
	private AccommodationReviewDto(List<ReviewDto> reviews, boolean userReviewed, int userCount) {
		this.reviews = reviews;
		this.userReviewed = userReviewed;
		this.userCount = userCount;
	}

	public static AccommodationReviewDto of(List<ReviewDto> reviews, boolean userReviewed, int userCount) {
