...
public class TagContentDto extends TagDto {
	...
	private TagContentDto(String name, String content, String content2) {
		this.name = name;
	...
	public static TagContentDto of(ReviewTag baseReviewData) {
		return new TagContentDto(baseReviewData.getName(), baseReviewData.getContent(), baseReviewData.getContent2());
	}

	public ReviewTypeDto convertToReviewTypeDto() {
		return new ReviewTypeDto(this.name, this.content2);
	}
}
